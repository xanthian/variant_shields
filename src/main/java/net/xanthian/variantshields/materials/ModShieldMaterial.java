...
public enum ModShieldMaterial implements ModShieldTiers {
    ...
    WOOD(79, 16, 140, 0, 0, 0, () -> Ingredient.fromTag(ModItemTags.WOODEN_SHIELDS)),

    STONE(175, 6, 120, 0, 0, 0, () -> Ingredient.fromTag(ModItemTags.STONE_SHIELDS)),

    IRON(336, 15, 100, 0, 0, 0, () -> Ingredient.fromTag(ModItemTags.IRON_SHIELDS)),

    DIAMOND(2091, 11, 80, 1, 2, 0, () -> Ingredient.fromTag(ModItemTags.DIAMOND_SHIELDS)),

    GOLD(42, 23, 60, 0, 0, 0, () -> Ingredient.fromTag(ModItemTags.GOLDEN_SHIELDS)),

    NETHERITE(2721, 16, 60, 2, 2, 0.05F, () -> Ingredient.fromTag(ModItemTags.NETHERITE_SHIELDS));
