...
public class ModCreativeTab {
    ...
    public static final ItemGroup ITEM_GROUP = Registry.register(Registries.ITEM_GROUP, new Identifier(MOD_ID, "variantshields"),

            FabricItemGroup.builder().displayName(Text.translatable("variantshields.item_group")).icon(() -> new ItemStack(Shields.MANGROVE_DIAMOND_SHIELD)).entries((context, entries) -> {
